...
#include "bl606p_irq.h"

#define DMA_CHANNEL_OFFSET 0x100

#ifndef BFLB_BOOT2
struct bflb_device_s bl606p_device_table[] = {
    { .name = "adc",
      .reg_base = AON_BASE,
#if defined(CPU_M0) || defined(CPU_LP)
      .irq_num = BL606P_IRQ_GPADC_DMA,
#else
      .irq_num = 0xff,
#endif
      .idx = 0,
    ...
    { .name = "cam0",
      .reg_base = DVP0_BASE,
#if defined(CPU_D0)
      .irq_num = BL606P_IRQ_DVP2BUS_INT0,
#else
      .irq_num = 0xff,
#endif
      .idx = 0,
    ...
    { .name = "cam1",
      .reg_base = DVP1_BASE,
#if defined(CPU_D0)
      .irq_num = BL606P_IRQ_DVP2BUS_INT1,
#else
      .irq_num = 0xff,
#endif
      .idx = 1,
    ...
    { .name = "cam2",
      .reg_base = DVP2_BASE,
#if defined(CPU_D0)
      .irq_num = BL606P_IRQ_DVP2BUS_INT2,
#else
      .irq_num = 0xff,
#endif
      .idx = 2,
    ...
    { .name = "cam3",
      .reg_base = DVP3_BASE,
#if defined(CPU_D0)
      .irq_num = BL606P_IRQ_DVP2BUS_INT3,
#else
      .irq_num = 0xff,
#endif
      .idx = 3,
    ...
    { .name = "cam4",
      .reg_base = DVP4_BASE,
#if defined(CPU_D0)
      .irq_num = BL606P_IRQ_DVP2BUS_INT4,
#else
      .irq_num = 0xff,
#endif
      .idx = 4,
    ...
    { .name = "cam5",
      .reg_base = DVP5_BASE,
#if defined(CPU_D0)
      .irq_num = BL606P_IRQ_DVP2BUS_INT5,
#else
      .irq_num = 0xff,
#endif
      .idx = 5,
    ...
    { .name = "cam6",
      .reg_base = DVP6_BASE,
#if defined(CPU_D0)
      .irq_num = BL606P_IRQ_DVP2BUS_INT6,
#else
      .irq_num = 0xff,
#endif
      .idx = 6,
    ...
    { .name = "cam7",
      .reg_base = DVP7_BASE,
#if defined(CPU_D0)
      .irq_num = BL606P_IRQ_DVP2BUS_INT7,
#else
      .irq_num = 0xff,
#endif
      .idx = 7,
...
{
    for (uint8_t i = 0; i < sizeof(bl606p_device_table) / sizeof(bl606p_device_table[0]); i++) {
        if (strcmp(bl606p_device_table[i].name, name) == 0) {
            return &bl606p_device_table[i];
        }
    }
    return NULL;
}
...
{
    for (uint8_t i = 0; i < sizeof(bl606p_device_table) / sizeof(bl606p_device_table[0]); i++) {
        if ((bl606p_device_table[i].dev_type == type) && (bl606p_device_table[i].idx = idx)) {
            return &bl606p_device_table[i];
        }
    }
    return NULL;
